...
<center><img src = "/home/thomas/Bureau/outside_kernel.png" width=200px></center>
<br/><span style = "font-size:14px"> <b>Figure 1</b>. Boundary issue for a 3 x 3 kernel. On the edges of the picture some parts of the kernel can be located outside the image.</span><br/>
...
<center><img src = "/home/thomas/Bureau/separable_kernel.png" width=400px></center>
<br/><span style = "font-size:14px"> <b>Figure 2</b>. Specific separable kernel. The original kernel (left) can be splitted into two 1-Dimension kernels. A row kernel and a column kernel. Each kernel will be applied to the picture separatly.</span><br/>
